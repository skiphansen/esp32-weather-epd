// To configure your local build without modifing config.cpp copy
// this file to local.h and edit it as desired.
...
const String LAT = "33.764651117558856";
const String LON = "-118.3364370854526";

// City name that will be shown in the top-right corner of the display.
const String CITY_STRING = "Rancho Palos Verdes";
...
const char *TIME_FORMAT = "%l:%M %P"; // 12-hour ex: 1:23 am  11:00 pm
